...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceType.text'
        db.alter_column('twitter_sourcetype', 'text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'SourceType.text'
        db.alter_column('twitter_sourcetype', 'text', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
