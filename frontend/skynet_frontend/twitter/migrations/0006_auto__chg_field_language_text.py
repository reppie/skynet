...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Language.text'
        db.alter_column('twitter_language', 'text', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))


    def backwards(self, orm):
        
        # Changing field 'Language.text'
        db.alter_column('twitter_language', 'text', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
