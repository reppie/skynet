...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('twitter_tweet', 'coordinates_id')


    def backwards(self, orm):
        
        # Adding field 'Tweet.coordinates'
        db.add_column('twitter_tweet', 'coordinates', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitter.Coordinates'], null=True, blank=True), keep_default=False)
