...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('twitter_user', 'language', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['twitter.Language']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('twitter_user', 'language_id')
    ...
    models = {
        ...
        'twitter.user': {
            ...
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['twitter.Language']"}),
