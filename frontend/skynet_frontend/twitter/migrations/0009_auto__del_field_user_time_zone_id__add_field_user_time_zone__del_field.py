...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'User.time_zone_id'
        db.delete_column('twitter_user', 'time_zone_id_id')

        # Adding field 'User.time_zone'
        db.add_column('twitter_user', 'time_zone', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['twitter.TimeZone']), keep_default=False)

        # Deleting field 'Place.bb_id'
        db.delete_column('twitter_place', 'bb_id_id')

        # Adding field 'Place.bounding_box'
        db.add_column('twitter_place', 'bounding_box', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['twitter.BoundingBox']), keep_default=False)

        # Deleting field 'Tweet.source_type_id'
        db.delete_column('twitter_tweet', 'source_type_id_id')

        # Adding field 'Tweet.source_type'
        db.add_column('twitter_tweet', 'source_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['twitter.SourceType']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'User.time_zone_id'
        db.add_column('twitter_user', 'time_zone_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['twitter.TimeZone']), keep_default=False)

        # Deleting field 'User.time_zone'
        db.delete_column('twitter_user', 'time_zone_id')

        # Adding field 'Place.bb_id'
        db.add_column('twitter_place', 'bb_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['twitter.BoundingBox']), keep_default=False)

        # Deleting field 'Place.bounding_box'
        db.delete_column('twitter_place', 'bounding_box_id')
        ...
        # Deleting field 'Tweet.source_type'
        db.delete_column('twitter_tweet', 'source_type_id')
