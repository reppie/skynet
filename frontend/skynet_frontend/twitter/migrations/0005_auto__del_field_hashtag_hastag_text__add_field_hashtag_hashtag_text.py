...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Hashtag.hastag_text'
        db.delete_column('twitter_hashtag', 'hastag_text')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Hashtag.hastag_text'
        db.add_column('twitter_hashtag', 'hastag_text', self.gf('django.db.models.fields.CharField')(default='', max_length=139), keep_default=False)
