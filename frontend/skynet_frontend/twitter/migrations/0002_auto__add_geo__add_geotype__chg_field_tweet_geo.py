...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Tweet.geo' to match new field type.
        db.rename_column('twitter_tweet', 'geo', 'geo_id')
        # Changing field 'Tweet.geo'
        db.alter_column('twitter_tweet', 'geo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitter.Geo'], null=True))

        # Adding index on 'Tweet', fields ['geo']
        db.create_index('twitter_tweet', ['geo_id'])


    def backwards(self, orm):
        
        # Removing index on 'Tweet', fields ['geo']
        db.delete_index('twitter_tweet', ['geo_id'])
        ...
        # Renaming column for 'Tweet.geo' to match new field type.
        db.rename_column('twitter_tweet', 'geo_id', 'geo')
        # Changing field 'Tweet.geo'
        db.alter_column('twitter_tweet', 'geo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
