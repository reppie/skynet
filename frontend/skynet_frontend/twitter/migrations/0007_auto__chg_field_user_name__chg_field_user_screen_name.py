...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('twitter_user', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'User.screen_name'
        db.alter_column('twitter_user', 'screen_name', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))


    def backwards(self, orm):
        
        # Changing field 'User.name'
        db.alter_column('twitter_user', 'name', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'User.screen_name'
        db.alter_column('twitter_user', 'screen_name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
