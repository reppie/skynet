...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('twitter_coordinate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coordinate_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitter.CoordinateType'], null=True, blank=True)),
            ('coordinates', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('twitter', ['Coordinate'])

        # Adding model 'CoordinateType'
        db.create_table('twitter_coordinatetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal('twitter', ['CoordinateType'])

        # Renaming column for 'Tweet.coordinates' to match new field type.
        db.rename_column('twitter_tweet', 'coordinates', 'coordinates_id')
        # Changing field 'Tweet.coordinates'
        db.alter_column('twitter_tweet', 'coordinates_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitter.Coordinate'], null=True))

        # Adding index on 'Tweet', fields ['coordinates']
        db.create_index('twitter_tweet', ['coordinates_id'])


    def backwards(self, orm):
        
        # Removing index on 'Tweet', fields ['coordinates']
        db.delete_index('twitter_tweet', ['coordinates_id'])

        # Deleting model 'Coordinate'
        db.delete_table('twitter_coordinate')

        # Deleting model 'CoordinateType'
        db.delete_table('twitter_coordinatetype')

        # Renaming column for 'Tweet.coordinates' to match new field type.
        db.rename_column('twitter_tweet', 'coordinates_id', 'coordinates')
        # Changing field 'Tweet.coordinates'
        db.alter_column('twitter_tweet', 'coordinates', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'twitter.coordinate': {
            ...
            'coordinate_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['twitter.CoordinateType']", 'null': 'True', 'blank': 'True'}),
            'coordinates': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'twitter.coordinatetype': {
            'Meta': {'object_name': 'CoordinateType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
        'twitter.country': {
        ...
        'twitter.tweet': {
            ...
            'coordinates': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['twitter.Coordinate']", 'null': 'True', 'blank': 'True'}),
