...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'User', fields ['screen_name']
        db.create_unique('twitter_user', ['screen_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'User', fields ['screen_name']
        db.delete_unique('twitter_user', ['screen_name'])
    ...
    models = {
        ...
        'twitter.user': {
            ...
            'screen_name': ('django.db.models.fields.CharField', [], {'max_length': '15', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
