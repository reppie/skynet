...
class TweetTest(TestCase):
    def setUp(self):
        ...
        self.tweet = Tweet(text=self.text, id=self.id, created_at=self.created_at, user=self.user)
...
class TweetIndexTest(TestCase):
    ...
    def test_get_all_since(self):
        ...
        really_old_tweet = Tweet(text="oldtweet", id=1338, created_at=long_ago, user=user)
