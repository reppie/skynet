...
#        exclude.extend(stored_blacklist)
        ...
        stored_blacklist = BlacklistItem.objects.all().values_list('keyword__keyword', flat=True)
        print stored_blacklist
        query_set = query_set.all().exclude(keyword__in=stored_blacklist)[:num_keywords]
